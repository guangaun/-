<!--
 * @Author: your name
 * @Date: 2021-12-22 20:31:50
 * @LastEditTime: 2021-12-22 20:54:14
 * @LastEditors: your name
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \group-2\am-ui\src\pages\am\monitor\Video.vue
-->
<template>
  <div>
    <el-row>
      ...
      <el-col :span="18">
        <div v-if="params.device_id">
          <video :src="device.video" 
            autoplay
            controls 
            loop
            style="display:block;width:90%;margin:0 auto"></video>  
        </div>
