    ...
    >
      ...
      <el-table-column label="操作" fixed="right" align="center" width="130">
        <template slot-scope="scope">
          <el-button size="small" type="text" @click.prevent="toEdit(scope.row)">修改</el-button>
          <el-button size="small" type="text" class="delete" @click.prevent="deleteHandler(scope.row.id)">移除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 模态框 -->
